...
<body>
    <div class="flex">
        ...
        <!--End of Dashbaord List-->
         ...
         <!--Middle List List-->
         <div class="middle bg-white pt-3 p-4 main-content">
            ...
            <h3>All Cars</h3>
            <button class="btn btn-primary"><a style='text-decoration:none; color:white' href="../admin/dashboard-create-cars.php">Add New Car</a></button>
            </div>
